...
export default function TypeC() {
    return (
        <div className="font-dung background-pattern p-8 bg-black text-white min-h-screen flex flex-col">
            ...
            <div className="z-10 bg-transparent md:grid gap-4 md:grid-cols-5 mt-4">
                <Link href="/type-c/category-1">
                    <div className="p-5 text-center border-2 border-white flex flex-col items-center justify-center mb-4 h-18 md:h-48 bg-black">
                ...
                <Link href="/type-c/category-5">
                    <div className="p-5 text-center border-2 border-white flex flex-col items-center justify-center h-18 md:h-48 bg-black">
